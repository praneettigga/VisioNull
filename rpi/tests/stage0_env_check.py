...
def main():
    ...
    model_path = os.path.join(PROJECT_ROOT, "model", "pose_landmarker_lite.task")
    ...
    modules = [
        ...
        ("src.pipeline.camera_stream", "Camera Stream"),
        ("src.pipeline.pose_estimator", "Pose Estimator"),
        ("src.pipeline.fall_detector", "Fall Detector"),
        ("src.notification.notifier", "Notifier"),
    ]
